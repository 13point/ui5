 ...
 */
@Entity
@Table(name = "cart_product", catalog = "ec_core")
public final class CartProduct implements java.io.Serializable {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 6749834299951259786L;
    ...
    /**
     * Instantiates a new cart product.
     */
    public CartProduct() {
    }
     ...
     * @param id the new id
     */
    public void setId(final CartProductId id) {
        this.id = id;
    }
